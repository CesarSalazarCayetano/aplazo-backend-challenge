...
public class LoanIntegrationTest {
	...
	private static final String LOAN_PATH = "/protected/loans";
	...
	void shouldReturn401WhenNotSendHeaderAuthorization() throws JsonProcessingException {
		var urlApi = BASE_API + this.port + CONTEXT_PATH + LOAN_PATH;
...
//		header.add(CONTEXT_PATH, BASE_API);
		...
		bodyParamMap.put("idCustomer", "9e6256ec-1cba-4c4f-b9ea-475599bf6a2b");
		bodyParamMap.put("amount", 1000.00D);
